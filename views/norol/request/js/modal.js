window.addEventListener("load", function () {
    ...
    // let openModalImg = document.querySelector("#imgFotoPerfil");
    let openModalImg = document.querySelector("div[name='vista_previa']");
    openModalImg.addEventListener("load", function () {
        
    })

    openModalImg.addEventListener("click", function () {
        let inputImg = document.querySelector("#imgDesktop");
        if (inputImg.files.length == 0) {
            alert("¡¡Debes seleccionar una imágen para poder visualizarla!!");
        } else {
            //ev.preventDefault();
