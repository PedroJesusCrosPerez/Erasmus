...
<?php
$thisdir = "views/coordinator/crud_convocatory/";
echo '
<head>
...
<div id="crud_convocatory">
    ...
    <form id="form_crud_convocatory" name="crud_convocatory" accept-charset="utf-8" autocomplete="off" enctype="multipart/form-data" method="post" formtarget="_blank" formnovalidate="formnovalidate"> <!--action="?menu=actionLogin">-->
